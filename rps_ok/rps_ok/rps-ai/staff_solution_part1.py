...
def play_again():
    ...
    #prompt = ">>>>>>>>>>YOUR CODE HERE X<<<<<<<<<<"
    prompt = "Want to play again? Starter"
...
def basic_ai():
    ...
    #moves = ["rock", "gun", "scissors"]
    moves = ["rock", "paper", "paper"]
...
def main():
    ...
    while continue_playing:
        ...
        play(name) # Actual corect
        # play(name, rock_ai) # what will allow the tests to work
